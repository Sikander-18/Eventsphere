      ...
      <form onSubmit={submit} className="panel w-full max-w-2xl p-6 space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1">
            ...
            <input className="field" placeholder="e.g. John Doe" value={form.name} onChange={(event) => setForm({ ...form, name: event.target.value })} required />
          </div>
          ...
          <div className="space-y-1">
            ...
            <input className="field" type="password" placeholder="Create a password" value={form.password} onChange={(event) => setForm({ ...form, password: event.target.value })} required />
          </div>
          ...
          <div className="space-y-1 sm:col-span-2">
            ...
            <input className="field" placeholder="e.g. https://linkedin.com/in/username" value={form.linkedinUrl} onChange={(event) => setForm({ ...form, linkedinUrl: event.target.value })} />
